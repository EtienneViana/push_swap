...
/*   Updated: 2019/04/15 11:06:34 by eviana           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

static void	answer_print(t_pile *pile_a, t_pile *pile_b)
{
	if (pile_b->size == 0)
	{
...
int			main(int argc, char **argv)
{
	...
	if (argc < 2 || !check_alldigit(argc, argv))
		put_error(NULL, NULL, NULL, NULL);
	if (!(pile_a = pile_get(argc, argv)))
		put_error(NULL, NULL, NULL, NULL);
